...
- **Scope**: Requires refactoring [Block.tsx](src/components/Block.tsx) and [Scene.tsx](src/components/Scene.tsx) significantly.
- **Reference**: See performance guidelines in [POTATO_MODE.md](POTATO_MODE.md).
